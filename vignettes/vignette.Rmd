...
grid_max <- ceiling(max(Voronoi_centroid[,1:2]))
grid_unit <- grid_max / 200
##  tmp_grid as the collection of tiles to do clustering; can be changed to other options
...
##  Use CancerAbstract::distanceGrid(), CancerAbstract::clusterGrid() to get Delaunay triangulations
